...
export const HomeAbout = () => {
  return (
    <div className="main-about m-auto max-w-c-xl  grid-cols-2 px-4 py-16 lg:grid lg:grid-rows-custom-min  lg:gap-x-8  lg:py-20">
      <div className="col-start-2 col-end-3 row-start-1 row-end-2 aspect-video max-h-min bg-amber-100 lg:aspect-video lg:h-full">
        <img src={'images/IMG_20210318_115012.jpg'} alt="" className="h-full w-full rounded-md object-fill"></img>
      </div>
