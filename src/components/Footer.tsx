    ...
    <footer className="bg-black-75 ">
      ...
      <div className="m-auto grid max-w-c-xl grid-cols-1 gap-8 px-4 py-16 md:grid-cols-3  lg:py-20">
        <ul className="list-none text-hm-black10">
          ...
          <li className="pb-2">ul. Romualda Traugutta 40</li>
          <li className="">64-000 Kościan</li>
        </ul>
        <ul className="list-none text-hm-black10">
          <li className="pb-3 text-xl text-hm-yellow">Biuro / Zakład produkcyjny</li>
        ...
        <ul className=" flex-1 list-none text-hm-black10">
          <li className="pb-3  text-xl text-hm-yellow">Kontakt</li>
          ...
          <li className=" grid grid-flow-row grid-cols-12 pb-2 ">
